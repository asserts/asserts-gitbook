...
<table>
  ...
  <tbody>
    ...
    <tr><td><code>asserts_entity_type</code></td><td>Used by Asserts to identify at what level is the metric being observed. The <code>workload</code>, <code>service</code>, <code>job</code> are special labels that Asserts uses to discover the <code>Service</code>. In this example, while aggregating, these labels are being retained. So this metric will be observed for the corresponding <code>Service</code> entity</td></tr>
  </tbody>
</table>
